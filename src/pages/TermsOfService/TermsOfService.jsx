    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-100 py-10 px-6 lg:px-20">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="mb-4 text-lg">
          Welcome to MilesAhead! By accessing or using our platform, you agree to
        ...
        <section className="mb-8">
          ...
          <p>
            By using MilesAhead, you agree to comply with and be legally bound by
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            guardian to use our services. By using MilesAhead, you represent and
        ...
        <section className="mb-8">
          ...
          <p>
            MilesAhead is not liable for any direct, indirect, incidental,
        ...
        <section className="mb-8">
          ...
          <p>
            MilesAhead may update these Terms of Service from time to time. Any
