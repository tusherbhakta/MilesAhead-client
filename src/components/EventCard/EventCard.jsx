                    ...
                    >
                        ...
                        <div className="p-6">
                            ...
                            <Link
                                ...
                                className="mt-4 block w-full text-center bg-lime-600 text-white hover:text-white hover:bg-lime-700 font-bold py-2 rounded-lg shadow-lg hover:bg-lime-600 transition-all duration-300"
                            >
                                Learn More
                            </Link>
                        </div>
