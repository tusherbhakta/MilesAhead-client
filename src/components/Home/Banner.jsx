            ...
            <div className="max-w-7xl mx-auto px-4 py-10 lg:py-16 grid grid-cols-1 md:grid-cols-2 items-center lg:justify-between">
                ...
                <div className=" max-w-2xl">
                    <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                        Empower Dreams with{" "}
                        <span className="dark:text-lime-400 text-lime-600">MilesAhead</span>
                    </h1>
                    ...
                    <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-start">
                        <Link to={'/add-campaign'} className="px-6 py-3 bg-lime-500 hover:bg-lime-400 text-white text-lg font-medium rounded-lg shadow-lg transition-all">
                            Start a Campaign
                        </Link>
